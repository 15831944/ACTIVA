...
namespace ACTIVA_Module_1.modules
{
    class mod_accueil
    {
        ...
        public static void Reset_Accueil_Tab()
        {
        ...
        public static void Get_Selected_Ouvrage_Info(string nodename, string nodetype, string nodeforme, System.Windows.Forms.Label obs_name, System.Windows.Forms.Label obs_nb)
        {
            ...
            mod_global.MF.ouvrageLb.Text = ACTIVA_Module_1.modules.mod_accueil.OUVRAGE;
            OUVRAGE = nodename;
        ...
        public static string Get_New_Obs_Num()
        {
            ...
            XmlNodeList svfnodelist = SVF.DocumentElement.SelectNodes("/inspection/ouvrage[@nom='" + mod_accueil.OUVRAGE + "']/observations/code");
